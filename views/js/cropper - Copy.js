...
! function(t) {
    ...
    function l(e, s) {
        ...
        return v && (a = C / 2, o = b / 2), w && (h = c({
            ...
            height: b,
            degree: u
        }), C = h.width, b = h.height, a = C / 2, o = b / 2), n.width = C, n.height = b, x && (p = -d / 2, l = -g / 2, r.save(), r.translate(a, o)), w && r.rotate(u * Math.PI / 180), v && r.scale(f, m), r.drawImage(e, $t(p), $t(l), $t(d), $t(g)), x && r.restore(), n
    }
    ...
    function u(t) {
        ...
        if (n && (e = n + 4, s = n + 10, "Exif" === g(l, e, 4) && (h = l.getUint16(s), o = 18761 === h, (o || 19789 === h) && 42 === l.getUint16(s + 2, o) && (a = l.getUint32(s + 4, o), a >= 8 && (r = s + a)))), r)
    ...
    v.prototype = {
        ...
        clone: function() {
            var i, e, s = this.options,
                ...
                r = this.url,
                p = "";
            s.checkCrossOrigin && o(r) && (p = a.prop("crossOrigin"), p ? i = r : (p = "anonymous", i = h(r))), this.crossOrigin = p, this.crossOriginUrl = i, this.$clone = e = t("<img" + n(p) + ' src="' + (i || r) + '">'), this.isImg ? a[0].complete ? this.start() : a.one(I, t.proxy(this.start, this)) : e.one(I, t.proxy(this.start, this)).one(F, t.proxy(this.stop, this)).addClass(Y).insertAfter(a)
        },
        start: function() {
            var i = this.$element,
                e = this.$clone;
        ...
        limitCanvas: function(t, i) {
            var e, s, a, o, h = this.options,
                ...
                g = this.cropBox,
                u = this.isCropped && g;
            t && (e = vt(h.minCanvasWidth) || 0, s = vt(h.minCanvasHeight) || 0, n && (n > 1 ? (e = xt(e, p), s = xt(s, c), 3 === n && (s * d > e ? e = s * d : s = e / d)) : e ? e = xt(e, u ? g.width : 0) : s ? s = xt(s, u ? g.height : 0) : u && (e = g.width, s = g.height, s * d > e ? e = s * d : s = e / d)), e && s ? s * d > e ? s = e / d : e = s * d : e ? s = e / d : s && (e = s * d), l.minWidth = e, l.minHeight = s, l.maxWidth = 1 / 0, l.maxHeight = 1 / 0), i && (n ? (a = p - l.width, o = c - l.height, l.minLeft = wt(0, a), l.minTop = wt(0, o), l.maxLeft = xt(0, a), l.maxTop = xt(0, o), u && this.isLimited && (l.minLeft = wt(g.left, g.left + g.width - l.width), l.minTop = wt(g.top, g.top + g.height - l.height), l.maxLeft = g.left, l.maxTop = g.top, 2 === n && (l.width >= p && (l.minLeft = wt(0, a), l.maxLeft = xt(0, a)), l.height >= c && (l.minTop = wt(0, o), l.maxTop = xt(0, o))))) : (l.minLeft = -l.width, l.minTop = -l.height, l.maxLeft = p, l.maxTop = c))
        },
        renderCanvas: function(t) {
            ...
            this.isRotated && (this.isRotated = !1, e = c({
                ...
                height: a.height,
                degree: o
            }), i = e.width / e.height, i !== s.aspectRatio && (s.left -= (e.width - s.width) / 2, s.top -= (e.height - s.height) / 2, s.width = e.width, s.height = e.height, s.aspectRatio = i, s.naturalWidth = h, s.naturalHeight = n, o % 180 && (e = c({
                width: h,
                height: n,
                degree: o
        ...
        renderCropBox: function() {
            var t = this.options,
                ...
                s = i.height,
                a = this.cropBox;
            (a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft), (a.height > a.maxHeight || a.height < a.minHeight) && (a.top = a.oldTop), a.width = wt(xt(a.width, a.minWidth), a.maxWidth), a.height = wt(xt(a.height, a.minHeight), a.maxHeight), this.limitCropBox(!1, !0), a.oldLeft = a.left = wt(xt(a.left, a.minLeft), a.maxLeft), a.oldTop = a.top = wt(xt(a.top, a.minTop), a.maxTop), t.movable && t.cropBoxMovable && this.$face.data(it, a.width === e && a.height === s ? dt : ct), this.$cropBox.css({
                width: a.width,
                height: a.height,
                left: a.left,
                top: a.top
        ...
        preview: function() {
            ...
            this.isCropped && !this.isDisabled && (this.$clone2.css({
                ...
                var e = t(this),
                    ...
                    u = d,
                    f = 1;
                a && (f = l / a, u = o * f), o && u > d && (f = d / o, g = a * f, u = d), e.css({
                    width: g,
                    height: u
                }).find("img").css({
                    width: h * f,
        ...
        dblclick: function() {
            this.isDisabled || (this.$dragBox.hasClass(W) ? this.setDragMode(dt) : this.setDragMode(lt))
        },
        wheel: function(i) {
        ...
        cropStart: function(i) {
            ...
            if (!this.isDisabled) {
                ...
                if (s = s || t(n.target).data(it), Q.test(s)) {
                    ...
                    i.preventDefault(), this.action = s, this.cropping = !1, this.startX = n.pageX || o && o.pageX, this.startY = n.pageY || o && o.pageY, s === lt && (this.cropping = !0, this.$dragBox.addClass(X))
                }
            }
        },
        cropMove: function(t) {
        ...
        cropEnd: function(t) {
            var i = t.originalEvent,
                e = this.action;
            this.isDisabled || e && (t.preventDefault(), this.cropping && (this.cropping = !1, this.$dragBox.toggleClass(X, this.isCropped && this.options.modal)), this.action = "", this.trigger(q, {
                originalEvent: i,
                action: e
            }))
        },
        change: function(t, i) {
            var e, s, a = this.options,
                ...
                x = n.height,
                C = !0;
            switch (!o && t && (o = c && l ? c / l : 1), this.isLimited && (m = p.minLeft, v = p.minTop, w = m + wt(n.width, r.left + r.width), x = v + wt(n.height, r.top + r.height)), s = {
                ...
                case rt:
                    if (o) {
                        ...
                        l -= s.y, g += s.y, c = l * o
                    } else s.x >= 0 ? u < w ? c += s.x : s.y <= 0 && g <= v && (C = !1) : c += s.x, s.y <= 0 ? g > v && (l -= s.y, g += s.y) : (l -= s.y, g += s.y);
                    c < 0 && l < 0 ? (h = nt, l = 0, c = 0) : c < 0 ? (h = pt, c = 0) : l < 0 && (h = ht, l = 0);
                    break;
                case pt:
                    if (o) {
                        if (s.y <= 0 && (g <= v || d <= m)) {
                    ...
                    } else s.x <= 0 ? d > m ? (c -= s.x, d += s.x) : s.y <= 0 && g <= v && (C = !1) : (c -= s.x, d += s.x), s.y <= 0 ? g > v && (l -= s.y, g += s.y) : (l -= s.y, g += s.y);
                    c < 0 && l < 0 ? (h = ht, l = 0, c = 0) : c < 0 ? (h = rt, c = 0) : l < 0 && (h = nt, l = 0);
                    break;
                case nt:
                    if (o) {
                        if (s.x <= 0 && (d <= m || f >= x)) {
                        ...
                        c -= s.x, d += s.x, l = c / o
                    } else s.x <= 0 ? d > m ? (c -= s.x, d += s.x) : s.y >= 0 && f >= x && (C = !1) : (c -= s.x, d += s.x), s.y >= 0 ? f < x && (l += s.y) : l += s.y;
                    c < 0 && l < 0 ? (h = rt, l = 0, c = 0) : c < 0 ? (h = ht, c = 0) : l < 0 && (h = pt, l = 0);
                    break;
                case ht:
                    if (o) {
                        if (s.x >= 0 && (u >= w || f >= x)) {
                        ...
                        c += s.x, l = c / o
                    } else s.x >= 0 ? u < w ? c += s.x : s.y >= 0 && f >= x && (C = !1) : c += s.x, s.y >= 0 ? f < x && (l += s.y) : l += s.y;
                    c < 0 && l < 0 ? (h = pt, l = 0, c = 0) : c < 0 ? (h = nt, c = 0) : l < 0 && (h = rt, l = 0);
                    break;
                case dt:
                ...
                case lt:
                    ...
                    e = this.$cropper.offset(), d = this.startX - e.left, g = this.startY - e.top, c = p.minWidth, l = p.minHeight, s.x > 0 ? h = s.y > 0 ? ht : rt : s.x < 0 && (d -= c, h = s.y > 0 ? nt : pt), s.y < 0 && (g -= l), this.isCropped || (this.$cropBox.removeClass(T), this.isCropped = !0, this.isLimited && this.limitCropBox(!0, !0))
            }
            C && (p.width = c, p.height = l, p.left = d, p.top = g, this.action = h, this.renderCropBox()), this.startX = this.endX, this.startY = this.endY
        },
        crop: function() {
            this.isBuilt && !this.isDisabled && (this.isCropped || (this.isCropped = !0, this.limitCropBox(!0, !0), this.options.modal && this.$dragBox.addClass(X), this.$cropBox.removeClass(T)), this.setCropBoxData(this.initialCropBox))
        },
        reset: function() {
        ...
        clear: function() {
            this.isCropped && !this.isDisabled && (t.extend(this.cropBox, {
                ...
                width: 0,
                height: 0
            }), this.isCropped = !1, this.renderCropBox(), this.limitCanvas(!0, !0), this.renderCanvas(), this.$dragBox.removeClass(X), this.$cropBox.addClass(T))
        },
        ...
        destroy: function() {
            var t = this.$element;
            this.isLoaded ? (this.isImg && this.isReplaced && t.attr("src", this.originalUrl), this.unbuild(), t.removeClass(T)) : this.isImg ? t.off(I, this.start) : this.$clone && this.$clone.remove(), t.removeData(L)
        },
        move: function(t, i) {
            var s = this.canvas;
        ...
        zoomTo: function(t, i) {
            ...
            if (t = vt(t), t >= 0 && this.isBuilt && !this.isDisabled && n.zoomable) {
                ...
                }, r.left -= (s - p) * ((h.pageX - o.left - r.left) / p), r.top -= (a - c) * ((h.pageY - o.top - r.top) / c)) : (r.left -= (s - p) / 2, r.top -= (a - c) / 2), r.width = s, r.height = a, this.renderCanvas(!0)
            }
        },
        rotate: function(t) {
        ...
        getCroppedCanvas: function(i) {
            ...
            if (this.isBuilt && ft) return this.isCropped ? (t.isPlainObject(i) || (i = {}), g = this.getData(), e = g.width, s = g.height, p = e / s, t.isPlainObject(i) && (h = i.width, n = i.height, h ? (n = h / p, r = h / e) : n && (h = n * p, r = n / s)), a = $t(h || e), o = $t(n || s), c = t("<canvas>")[0], c.width = a, c.height = o, d = c.getContext("2d"), i.fillColor && (d.fillStyle = i.fillColor, d.fillRect(0, 0, a, o)), d.drawImage.apply(d, function() {
                ...
                return m <= -e || m > c ? m = t = a = h = 0 : m <= 0 ? (a = -m, m = 0, t = h = wt(c, e + m)) : m <= c && (a = 0, t = h = wt(e, c - m)), t <= 0 || v <= -s || v > d ? v = i = o = n = 0 : v <= 0 ? (o = -v, v = 0, i = n = wt(d, s + v)) : v <= d && (o = 0, i = n = wt(s, d - v)), f.push($t(m), $t(v), $t(t), $t(i)), r && (a *= r, o *= r, h *= r, n *= r), h > 0 && n > 0 && f.push($t(a), $t(o), $t(h), $t(n)), f
        ...
        setDragMode: function(t) {
            var i, e, s = this.options;
            this.isLoaded && !this.isDisabled && (i = t === lt, e = s.movable && t === dt, t = i || e ? t : ut, this.$dragBox.data(it, t).toggleClass(W, i).toggleClass(M, e), s.cropBoxMovable || this.$face.data(it, t).toggleClass(W, i).toggleClass(M, e))
        }
    }, v.DEFAULTS = {
        viewMode: 0,
        dragMode: "crop",
